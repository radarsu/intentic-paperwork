/* WHICH TOOL CONVERTS WHAT: the decision half of the CLI, kept pure so it can be tested without any of the binaries being installed. */
...
/* What the person almost certainly meant when they didn't say. */
...
/* Every binary this pack drives, and which subcommand needs it: so a missing tool can be named before anything runs. */
export const TOOLS = {
